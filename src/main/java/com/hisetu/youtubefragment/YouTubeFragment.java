...
public final class YouTubeFragment extends YouTubePlayerFragment
    ...
    public void onInitializationSuccess(YouTubePlayer.Provider provider, YouTubePlayer player, boolean restored) {
        ...
        setPlaybackEventListener(player);
        setPlayerStateChangeListener(player);
    }

    private void setPlaybackEventListener(YouTubePlayer player) {
    ...
    private void setPlayerStateChangeListener(YouTubePlayer player) {
